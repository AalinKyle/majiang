...
public class RemoveZiPlayer extends BasePlayer {
    public RemoveZiPlayer() {
    }

    public RemoveZiPlayer(User user, Comparator<Maj> sort, boolean enableLog) {
        super(user, sort, enableLog);
    }

    public RemoveZiPlayer(User user, Comparator<Maj> sort) {
        super(user, sort);
    }
